...
static int health_code(LampID id, Lamp_Channel channel)
{
    ...
    {
        if (signals_get_lamp_status(id, channel) == lamp_checker_get_lamp_status(id, channel))
            return 0;
        else
            return 1;
    }
    ...
    {
        if (lamp_checker_get_lamp_status(id, channel))
            return 1;
        else
            return 0;
    }
...
void lamp_checker_log_lamp_status()
{
    ...
    primary["red"] = lamp_checker_get_lamp_status(LampID::PRIMARY, Lamp_Channel::RED);
    primary["amber"] = lamp_checker_get_lamp_status(LampID::PRIMARY, Lamp_Channel::AMBER);
    primary["g_fwd"] = lamp_checker_get_lamp_status(LampID::PRIMARY, Lamp_Channel::GREEN_FWD);
    primary["g_left"] = lamp_checker_get_lamp_status(LampID::PRIMARY, Lamp_Channel::GREEN_LEFT);
    primary["g_right"] = lamp_checker_get_lamp_status(LampID::PRIMARY, Lamp_Channel::GREEN_RIGHT);

    JsonObject &secondary = root.createNestedObject("secondary");
    secondary["red"] = lamp_checker_get_lamp_status(LampID::SECONDARY, Lamp_Channel::RED);
    secondary["amber"] = lamp_checker_get_lamp_status(LampID::SECONDARY, Lamp_Channel::AMBER);
    secondary["g_fwd"] = lamp_checker_get_lamp_status(LampID::SECONDARY, Lamp_Channel::GREEN_FWD);
    secondary["g_left"] = lamp_checker_get_lamp_status(LampID::SECONDARY, Lamp_Channel::GREEN_LEFT);
    secondary["g_right"] = lamp_checker_get_lamp_status(LampID::SECONDARY, Lamp_Channel::GREEN_RIGHT);

    JsonObject &spare = root.createNestedObject("spare");
    spare["red"] = lamp_checker_get_lamp_status(LampID::SPARE, Lamp_Channel::RED);
    spare["amber"] = lamp_checker_get_lamp_status(LampID::SPARE, Lamp_Channel::AMBER);
    spare["g_fwd"] = lamp_checker_get_lamp_status(LampID::SPARE, Lamp_Channel::GREEN_FWD);
    spare["g_left"] = lamp_checker_get_lamp_status(LampID::SPARE, Lamp_Channel::GREEN_LEFT);
    spare["g_right"] = lamp_checker_get_lamp_status(LampID::SPARE, Lamp_Channel::GREEN_RIGHT);

    JsonObject &overhead = root.createNestedObject("overhead");
    overhead["red"] = lamp_checker_get_lamp_status(LampID::OVERHEAD, Lamp_Channel::RED);
    overhead["amber"] = lamp_checker_get_lamp_status(LampID::OVERHEAD, Lamp_Channel::AMBER);
    overhead["g_fwd"] = lamp_checker_get_lamp_status(LampID::OVERHEAD, Lamp_Channel::GREEN_FWD);
    overhead["g_left"] = lamp_checker_get_lamp_status(LampID::OVERHEAD, Lamp_Channel::GREEN_LEFT);
    overhead["g_right"] = lamp_checker_get_lamp_status(LampID::OVERHEAD, Lamp_Channel::GREEN_RIGHT);
